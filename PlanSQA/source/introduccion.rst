...
+------------------------+-----------+----------------+--------------+-------------------+------------+----------+-----+
| **Plan SQA**           | Admin SQA | Admin Proyecto | Adm de Conf. | Desarrollo/Diseño | Pruebas SW | Plan SQA | Req |
+========================+===========+================+==============+===================+============+==========+=====+
| Desarrollar /          |  X        |    X           |              |                   |            |          |     |
...
+===========================================+===========+================+==============+===================+============+==========+=====+
| Desarrollar/Documentar el Plan de         |           | X              |              |                   |            |          |     |
| Desarrollo de Software y otros planes     |           |                |              |                   |            |          |     |
+-------------------------------------------+-----------+----------------+--------------+-------------------+------------+----------+-----+
...
| del sistema**                             |           |                |              |                   |            |          |     |
+===========================================+===========+================+==============+===================+============+==========+=====+
| Desarrollar/Documentar Requerimientos     |           |                |              |                   |            |          |  X  |
| del sistema                               |           |                |              |                   |            |          |     |
+-------------------------------------------+-----------+----------------+--------------+-------------------+------------+----------+-----+
| Requerimientos de Administración de       |           |                | X            |                   |            |          |     |
| la Configuración                          |           |                |              |                   |            |          |     |
+-------------------------------------------+-----------+----------------+--------------+-------------------+------------+----------+-----+
...
+-------------------------------------------+-----------+----------------+--------------+-------------------+------------+----------+-----+
| Evaluar/reportar el proceso de análisis   | X         |                |              |                   |            |          |     |
| de req. Del sistema                       |           |                |              |                   |            |          |     |
+-------------------------------------------+-----------+----------------+--------------+-------------------+------------+----------+-----+
| Resolver las recomendaciones de la        |           | X              |              |                   |            |          |     |
| auditoría                                 |           |                |              |                   |            |          |     |

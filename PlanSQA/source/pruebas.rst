...
+--------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Objetivo de la Prueba:   | Se focaliza en ejecutar cada módulo (o unidad mínima a ser probada, ej = una clase) lo que provee un mejor modo de manejar la integración de las unidades en componentes mayores.                                                                   |
|                          | Busca asegurar que el código funciona de acuerdo con las especificaciones y que el módulo lógico es válido.                                                                                                                                         |
+--------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Responsable:             | El encargado de diseñar y realizar esta prueba puede ser uno de los desarrolladores del sistema.                                                                                                                                                    |
+--------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Pasos:                   | 1. Determinar el ambiente de prueba.                                                                                                                                                                                                                |
...
+----------------------------------------------------------+----------------------------------------------------------------+------------------------------------------------+ 
| Gestor de Base de Datos                                  | PostgreSql, MySql, SQLlite3                                    |                                                |
+----------------------------------------------------------+----------------------------------------------------------------+------------------------------------------------+
| Herramienta para el seguimiento de errores               | Bugzilla                                                       |                                                |
+----------------------------------------------------------+----------------------------------------------------------------+------------------------------------------------+ 
| Conjunto de datos                                        |                                                                | Mínimamente se definirán un conjunto de datos  |
|                                                          |                                                                | que pongan a prueba los casos bordes.          |
+----------------------------------------------------------+----------------------------------------------------------------+------------------------------------------------+ 
